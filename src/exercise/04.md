...
-PropTypes is a development only feature, it will be automatically removed by Babel during compilation because it decreases performance

-<React.Fragment> and </React.Fragment> are called React Fragments. They are special kind of component from React which allows you to position two elements side-by-side rather than just nested. Shorter syntax for the same is: <> and </>
